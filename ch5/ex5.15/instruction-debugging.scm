...
;; 
;; a.
;; Add instruction counting to the register ma-
;; chine simulation. That is, have the machine model keep
;; track of the number of instructions executed.
;;
;; Solution: add a variable in the machine to keep track of the instructions
;; executed. Increase this value whenever 'execute' is called.
;;
;; b.
;; Extend the machine model’s interface to accept a new message that
;; prints the value of the instruction count and resets the count
;; to zero.
;;
;; Solution: add a new messages named 'print-instruction-count' and
;; 'reset-instruction-count' that call new procedures to perform these
;; operations.
