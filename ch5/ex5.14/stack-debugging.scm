...
;;
;; a.
;; Measure the number of pushes and the max-
;; imum stack depth required to compute n! for various small
;; values of n using the factorial machine shown in Figure
;; 5.11.
;;
;; b.
;; From your data determine formulas in terms of n for
;; the total number of push operations and the maximum stack
...
;; initialize the stack and print the statistics. You may want to
;; also modify the machine so that it repeatedly reads a value
;; for n, computes the factorial, and prints the result (as we
;; did for the  machine in Figure 5.4), so that you will not
;; have to repeatedly invoke get-register-contents, set-
;; register-contents!, and start.
