;; Exercise 5.19:
;;
;; Alyssa P. Hacker wants a breakpoint feature
;; in the simulator to help her debug her machine designs. You
;; have been hired to install this feature for her. She wants to
;; be able to specify a place in the controller sequence where
;; the simulator will stop and allow her to examine the state
;; of the machine.
;;
;; a.
;; You are to implement a procedure:
;; (set-breakpoint ⟨machine⟩ ⟨label⟩ ⟨n⟩)
;; that sets a breakpoint just before the nth instruction after
...
;; point and stop executing instructions. Alyssa can then use
