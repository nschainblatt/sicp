...
;; That is, before each instruction is executed,
;; the simulator should print the text of the instruction.
;;
;; Solution:
;; The text of the instruction is located in the car of the instruction object.
;; This was added earlier and was unused, but now we can use it for trace debugging when enabled.
;; Simply print  the instruction text with a newline.
;;
;; b.
;; Make the machine model accept trace-on and trace-off mes-
;; sages to turn tracing on and off.
;;
;; Solution:
;; Allow the machine to accept two new messages, enable-tracing and disable-tracing. These
;; will set an internal boolean value to true or false, which will enable or disabling the
;; printing of instructions during execution.
