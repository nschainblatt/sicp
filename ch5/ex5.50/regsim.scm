;; This is the regmachine module from exercise 5.19 which added debugging.
...
(define (get-contents register)
  (if (eq? (register 'get) '*unassigned*)
    (println "getting contents of register:" (register 'name) (register 'get)))
  (register 'get))
