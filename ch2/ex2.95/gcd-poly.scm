;; Since we lose precision with each integer division operation, the more times we have to recursively call gcd-terms to
;; get our answer the less accurate the final result will be.
