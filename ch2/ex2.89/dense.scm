(define (main)
  ...
  (let* ((int1 (make-integer 5))
         ...
         (polynomial1 (make-polynomial 'x (list (list 4 1) (list 3 2) (list 2 3) (list 1 4) (list 0 5))))
    ...
    (println (sub polynomial1 polynomial5))))
...
;; TODO:
;; 1. Create constructors to wrap polynomials in two types: ('polynomial 'dense 'x (1 2 3 4 5)) ('polynomial 'sparse' 'x ((1 2) (3 4)))
;; 2. Convert the existing polynomial package to a polynomial-sparse package, make a similar one for dense.
;; 3. Move shared procedures to a third parent package. Install the two packages in this parent package.
;; 4. The parent will have additional versions of the non-shared procedures that the two sub packages have these are
;;    simply to remove the outer type tag and call the appropriate sub-package procedure by the 'dense or 'sparse type.

;; TODO: make generic selectors:
;; - order
;; - coeff
;; - first-term
;; - rest-terms

;; TODO: make generic inner constructors
;; - make-term

;; TODO: make generic auxillary procedures
;; - adjoin-term

;; TODO: make generic predicates
;; - polynomial-zero? 
...
(define (install-polynomial-package)
  ...
  ;; Generic implementations for the sparse polynomial representation
