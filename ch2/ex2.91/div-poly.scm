...
(define (main)
  ...
  (let* ((polynomial1 (make-polynomial 'x (make-sparse-term-list (list (list 5 1) (list 0 -1)))))
         (polynomial2 (make-polynomial 'x (make-sparse-term-list (list (list 2 1) (list 0 -1)))))
         (polynomial3 (make-polynomial 'x (make-dense-term-list (list 1 2 3 4 5))))
         (polynomial4 (make-polynomial 'x (make-dense-term-list (list 6 7 8 9 10)))))

    (div polynomial1 polynomial2)
    (div polynomial3 polynomial4)))
