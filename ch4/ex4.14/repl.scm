;; The reason a custom version of map defined in our language works, but not the system version of map is because the system version
;; of map doesn't understand our language. More specifically, it doesn't know how to apply our custom lambda or defined procedures to
